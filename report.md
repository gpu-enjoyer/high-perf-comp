...
Задача распараллеливается нормально, но статическое разбиение работы местами ведёт себя менее удачно. Похоже на особенности распределения нагрузки и памяти.  
...
`parallel_sections` после 3 потоков перестаёт улучшаться.  
